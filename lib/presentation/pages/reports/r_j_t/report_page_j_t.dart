...
class ReportPageJT extends StatelessWidget {
  const ReportPageJT({super.key});
...
class _LeftReportFilterViewState extends State<LeftReportFilterView> {
  ...
  void listenToApi() {
    ...
    if (state is ReportSuccessJT) {
      setState(() {
        widget.dataTableViewModel =
            DataTableViewModelFactory.createTableViewModelFromReportJT(
                reportJameTaraz: state.model);
      });
    }
  }
}

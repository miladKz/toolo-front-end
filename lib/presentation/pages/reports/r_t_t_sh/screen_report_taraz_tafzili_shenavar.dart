...
class ScreenReportTarazTafziliShenavar extends StatefulWidget {
  const ScreenReportTarazTafziliShenavar({super.key});

  @override
  State<ScreenReportTarazTafziliShenavar> createState() => _ScreenReportTarazTafziliShenavarState();
}

class _ScreenReportTarazTafziliShenavarState extends State<ScreenReportTarazTafziliShenavar> {
  @override
  void initState() {
    super.initState();
  }
...
class _InitViewState extends State<InitView> {
  ...
  Widget build(BuildContext context) {
    ...
    listenToBaseData();
    return widget.isBaseDataFetch ? const ReportPageTTSh():const Center(child: CircularProgressIndicator(),);
  }

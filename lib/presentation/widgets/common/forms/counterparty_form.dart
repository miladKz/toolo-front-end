    ...
    return IgnorePointer(
      ...
      child: Column(
        ...
        children: [
          Container(
            child: Row( children: [
              TabButton(topRight: 8,bottomRight: 8,title: localization.details,onClick: () {

              },),
              TabButton(title: localization.otherDetails,onClick: () {

              },),
              TabButton(title: localization.addresses,onClick: () {

              },),
              TabButton(topLeft: 8,bottomLeft: 8,title: localization.groups,onClick: () {

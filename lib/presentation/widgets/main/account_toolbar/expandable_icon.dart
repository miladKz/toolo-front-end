...
class _ExpandableIconState extends State<ExpandableIcon>
        ...
        child: Material(
          ...
          child: Padding(padding: EdgeInsets.all(5),
            child: InkWell(
              ...
              child:_expandableIconController.isExpanded
                  ? Assets.ico.icCloseButtons.image(width: 20, height: 20) // Replace with your desired icon
                  : Assets.ico.icOpenButtons.image(width: 20, height: 20),
            ),
          ),
        ),
      ),
  ...
  _openExpandableButton(){
    return IconButton(
      onPressed: () {},
      icon: Assets.ico.icOpenButtons.image(width: 25, height: 25),
      style: ElevatedButton.styleFrom(
        shape: RoundedRectangleBorder(
            side: const BorderSide(color: Color(0xFFefe0f5), width: 1),
